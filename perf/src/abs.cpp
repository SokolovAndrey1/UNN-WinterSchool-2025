...
int main() {
    ...
    constexpr int small_iterations = 9;//100'000;
    ...
    constexpr int medium_iterations = 3;//10'000;
    bench_abs(medium_length, medium_iterations);

    //
    // Bench big sizes
    //
    constexpr int big_length = 16384;//524288;
    constexpr int big_iterations = 1;//1'000;
